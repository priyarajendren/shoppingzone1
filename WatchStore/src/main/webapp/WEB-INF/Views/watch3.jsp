...
<center>
<div>
<img src="<spring:url value="resources/images/watch15.jpg" />"alt="watches" width="900" height="350"/>">

</div>
<div class="container">
  <div class="jumbotron">
    <h3><b> JAQUET DROSS </b></h3> 
    <img src="<spring:url value="resources/images/watch13.jpg"/>" alt="watches" width="500" height="500"/>">
