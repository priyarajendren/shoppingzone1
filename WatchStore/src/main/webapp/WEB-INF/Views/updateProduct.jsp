...
<body>
	<div class="container" id="main">
		...
		<p>
		<h2 style="color: #3CGH42;">Welcome to the shopping world of your
			Time!!!!!</h2>
		</p>
  ...
  <li><a href="<spring:url value="/aboutus"/>">ABOUTUS</a></li>
		...
		<form:form method="POST" action="/WatchStore/upd">
			<table>
				...
				<tr>
					<td><form:label path="pricetag"> Price tag</form:label></td>
