...
<form:form action="/newshoppingcart/addProd"  method="post">
			<form:errors path="*" cssClass="formErrorBlock"/>
			<table>
				
				<tr>
					<td> <form:label path="pname">Enter the Product Name</form:label> </td>
					<td> <form:input path="pname"/> </td>
					<td> <form:errors path="pname"></form:errors> </td>
				</tr>
				
				<tr>
					<td> <form:label path="pricetag">Enter the Price Tag</form:label> </td>
					<td> <form:input path="pricetag"/> </td>
					<td> <form:errors path="pricetag"></form:errors></td>
				</tr>			
				<tr>
