...
<form:form action="/newshoppingcart/logup" commandName="cust" method="POST">
			...
			<table class="table">
				...
				<tr>
					<td><form:label path="email">Your Email Id </form:label></td>
				...
				<tr>
					<td><form:label path="addr">Your Address</form:label></td>
					<td><form:input path="addr"/> </td>
				</tr>
				<tr>
					<td><form:label path="phno">Your Phno</form:label></td>
